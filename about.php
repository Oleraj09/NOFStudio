...
<body>
    ...
    <div class="container">
        ...
        <div class="title">
            <div class="contents">
                <h1><u>About Us</u></h1>
                <h2> <br> Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi amet saepe atque praesentium, nobis consectetur. Sed voluptas nobis illo vel dolor sint, itaque unde molestiae nam recusandae suscipit ipsam consequuntur!</h2>  
            </div>
        </div>
    </div>
        ...
        <h2 class="our-team-heading">Our Team</h2>
                <div class="our-team">
                    <div class="team-member">
                        <img src="images/ole.jpg " alt="" />
                            <div class="designation">
                                <strong>Oleraj Hossin<br></strong>(Project Manager) 
                            </div>
                    </div>

                    <div class="team-member">
                        <img src="images/nuri.jpg" alt="" />
                            <div class="designation">
                                <strong>Ishmoth Ura Nuri<br></strong>(Lead Designer & Programmer)
                            </div>
                    </div>

                    <div class="team-member">
                        <img src="images/fiha.png " alt="" />
                            <div class="designation">
                                <strong>Fahmida Ahmed Feha<br></strong>(Programmer & Adviser)
                            </div>
                    </div>
                </div>       
    </div>
