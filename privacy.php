    ...
    <div class="container">
        ...
        <div class="title">
            <div class="contents">
                ...
                <h3> <br> We ar Very Consious about User Privecy. And We dont promote Pirated Content. We Provide Orginal content of us. All User are free to use content!</h3>  
            </div>
        </div>
    </div>
        <section class="Privacy">
            <div class="pcontainer">
                <div class="row">
                    <div class="post">
                        <div class="post1">
                            <h2>We receive and store information about you such as:</h2>
                            <ul>
                        ...
                        <div class="post2">
                            ...
                            <h4>
                            We use information to provide, analyze, administer, enhance and personalize our services and marketing efforts, to manage member referrals, to process your registration, your orders and your payments, and to communicate with you on these and other topics.
                            </h4>
                        </div>
                        <div class="post3">
                            ...
                            <h4>
                                <ul>
                                    ...
                                    <li>Giving others access to your account</li>
                                    <li>Profiles</li>
                                    <li>Removing device access to your Netflix account</li>
                                </ul>
                            </h4>
                        </div>
                        <div class="post4">
                            <h2>Why do we use these technologies?</h2>
                                <h4>We use these types of technologies for various reasons, like making it easy to access our services by remembering you when you return; to provide, analyze, understand and enhance the use of our services; to enforce our terms, prevent fraud; to improve site performance, monitor visitor traffic and actions on our site; and to deliver and tailor our marketing or advertising, and to understand interactions with our emails, marketing, and online ads on third party sites.</h4>         
                        </div>
                    </div>
                </div>
            </div>
