     ...
     <header>
      ...
      echo"  <form  action='update.php' method='POST'>
          ...
          <div class='set'><input type='text' class='from-control' placeholder='Enter Date of Birth' name='dob' value='".$result['DOB']."'></div><br><br>
              ...
              <div class='set'><input type='password' class='form-control' placeholder='Enter old password' name='oldp'><br></div>
              <div class='set'><input type='password' class='form-control' placeholder='Enter new password' name='newp'><br></div>
